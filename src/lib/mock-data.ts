...
export const mockPrototypes = [
  ...
  },
  {
    id: "p3",
    ideaId: "1",
    title: "FridgeMate – LINE連携版",
    description: "冷蔵庫の食材をLINEで管理できるBotです。バーコードを写真で送ると登録されます。",
    githubUrl: "https://github.com/example/fridgemate",
    demoUrl: undefined,
    author: { name: "LINE大好き", avatar: "L" },
    likes: 28,
  },
  {
    id: "p4",
    ideaId: "1",
    title: "StockList – 食材管理PWA",
    description: "オフラインでも使えるPWA版の食材管理アプリ。家族間での共有機能も実装しました。",
    githubUrl: "https://github.com/example/stocklist",
    demoUrl: "https://stocklist.vercel.app",
    author: { name: "PWA職人", avatar: "A" },
    likes: 19,
  },
  {
    id: "p5",
    ideaId: "3",
    title: "GomiAlert – ゴミ出しリマインダー",
    description: "郵便番号を登録するだけでゴミ収集日を自動取得し、前日夜にプッシュ通知するWebアプリです。",
    githubUrl: "https://github.com/example/gomialert",
    demoUrl: "https://gomialert.vercel.app",
    author: { name: "週末エンジニア", avatar: "W" },
    likes: 67,
  },
  {
    id: "p6",
    ideaId: "10",
    title: "FridgeRecipe – 残り物レシピ提案",
    description: "冷蔵庫の食材を入力するとAIがレシピを提案してくれます。Claude APIを使って実装しました。",
    githubUrl: "https://github.com/example/fridgerecipe",
    demoUrl: "https://fridgerecipe.vercel.app",
    author: { name: "AIエンジニア", avatar: "A" },
    likes: 53,
  },
];
